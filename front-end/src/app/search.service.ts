...
export class SearchService {
	...
	premades: { id: string, title: string, episode?: string, series?: string, shortDesc: string, poster: string }[] = [
		...
		{ id: "4", title: "Trouble in paradise", episode: "498", series: "Naruto Shippuden", shortDesc: null, poster: "assets/dev_assets/naruto-shippuden-498-cover.png" }
	]
	constructor() {
		for (let i = 0; i < 40; i++) {
